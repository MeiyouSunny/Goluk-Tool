...
public class TagRecommendListRequest extends GolukFastjsonRequest<TagGeneralRetBean> {

    public TagRecommendListRequest(int requestType, IRequestResultListener listener) {
