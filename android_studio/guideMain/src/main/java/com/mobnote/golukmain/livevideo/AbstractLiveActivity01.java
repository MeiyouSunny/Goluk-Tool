...
public abstract class AbstractLiveActivity01 extends BaseActivity implements View.OnClickListener,
        RtmpPlayerView.RtmpPlayerViewLisener, LiveDialogManager.ILiveDialogManagerFn, TimerManager.ITimerManagerFn, ILocationFn, IPCManagerFn, ILive,
        VideoSuqareManagerFn, ILiveMap, ILiveFnAdapter, IRequestResultListener {
        ...
        switch (what) {
            ...
            case MSG_H_UPLOAD_TIMEOUT:
                ...
                if (!isAlreadExit) {
                    ...
                    LiveDialogManager.getManagerInstance().showSingleBtnDialog(AbstractLiveActivity01.this,
    ...
    public void dialogManagerCallBack(int dialogType, int function, String data) {
        switch (dialogType) {
            ...
            case LiveDialogManager.DIALOG_TYPE_CONFIRM:
                ...
                if (isSucess) {
                    GolukUtils.showToast(AbstractLiveActivity01.this, this.getString(R.string.str_report_success));
                } else {
                    GolukUtils.showToast(AbstractLiveActivity01.this, this.getString(R.string.str_report_fail));
                }
        ...
        if (isShareLive) {
            if (10 == function) {
                if (TimerManager.RESULT_FINISH == result) {
                    ...
                    liveEnd();
                    if (!isAlreadExit) {
                        LiveDialogManager.getManagerInstance().showLiveExitDialog(AbstractLiveActivity01.this,
    ...
    public void VideoSuqare_CallBack(int event, int msg, int param1, Object param2) {
        if (event == VSquare_Req_VOP_GetShareURL_Video) {
            ...
            ProxyThirdShare sb = new ProxyThirdShare(AbstractLiveActivity01.this, sharePlatform, bean);
            sb.showAtLocation(AbstractLiveActivity01.this.getWindow().getDecorView(), Gravity.BOTTOM, 0, 0);
        }
    }
