...
public class TSettingsActivity extends BaseActivity implements OnClickListener, IPCManagerFn, ForbidBack {
    ...
    private void requestInfo() {
        ...
        if (mBaseApp.mIPCControlManager.isSupportTimeslapse()) {
            ...
            GolukDebugUtils.e("", "TSettingsActivity===getIPCControlManager============getGSensorMoreValueCfg======flag="
                    + flag);
        } else {
...
//			mAutoPhotoLayout.setVisibility(View.VISIBLE);
    ...
    public void IPCManage_CallBack(int event, int msg, int param1, Object param2) {
        ...
        if (event == ENetTransEvent_IPC_VDCP_CommandResp) {
            ...
            } else if (msg == IPC_VDCP_Msg_GetCollisionValueConf) { // 获取碰撞感应灵敏度
    ...
    private void callback_getCollisionControlCfg(int msg, int param1, Object param2) {
        if (param1 == RESULE_SUCESS) {
            try {
                ...
                if (textResId != -1)
                    mUrgentCrashDesc.setText(textResId);
            } catch (JSONException e) {
                e.printStackTrace();
            }
        }
