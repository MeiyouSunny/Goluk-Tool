...
public class ShareTypeLayout implements OnClickListener, IBaiduGeoCoderFn, IDialogDealFn {
	...
	public void setLocationAddress(String address){
		...
		if(mLocationState != LOCATION_STATE_FORBID){
	...
	public void onClick(View v) {
		int id = v.getId();
		if (id == R.id.share_type_bg) {
			if (mIsExit) {
				return;
			}
			switchTypeUI(TYPE_BG);
		} else if (id == R.id.share_type_sg) {
			if (mIsExit) {
				return;
			}
			switchTypeUI(TYPE_SG);
		} else if (id == R.id.share_type_ml) {
			if (mIsExit) {
				return;
			}
			switchTypeUI(TYPE_ML);
		} else if (id == R.id.share_type_ssp) {
			if (mIsExit) {
				return;
			}
			switchTypeUI(TYPE_SSP);
		} else if (id == R.id.share_open_layout) {
			if (mIsExit) {
				return;
			}
			...
			switchOpenAndClose(!mIsOpenShare);
		} else if (id == R.id.share_sayother) {
			if (mIsExit) {
				return;
			}
			click_input();
		} else if (id == R.id.share_address_layout) {
			click_location();
		} else if (id == R.id.activity_textview1) {
		...
		} else if (id == R.id.activity_textview2) {
		...
		} else if (id == R.id.join_activity_textview) {
