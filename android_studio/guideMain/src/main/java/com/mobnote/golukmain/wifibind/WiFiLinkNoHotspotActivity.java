 ...
 * Wifi扫描列表
 */
public class WiFiLinkNoHotspotActivity extends BaseActivity implements OnClickListener, WifiConnCallBack, ForbidBack {
...
//        this.setStateSwitch();
    ...
    private void toNextView() {
        setDefaultInfo();
        // 跳转到修改热点密码页面
        Intent modifyPwd = new Intent(WiFiLinkNoHotspotActivity.this, WiFiLinkCompleteActivity.class);
