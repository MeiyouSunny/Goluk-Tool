...
import com.rd.exoplayer2.source.AdaptiveMediaSourceEventListener;
...
import com.rd.exoplayer2.source.dash.manifest.DashManifestParser;
import com.rd.exoplayer2.source.dash.manifest.UtcTimingElement;
...
import com.rd.exoplayer2.upstream.ParsingLoadable;
...
public final class DashMediaSource implements MediaSource {
  ...
  private static final class PeriodSeekInfo {
    ...
    public static PeriodSeekInfo createPeriodSeekInfo(
        com.rd.exoplayer2.source.dash.manifest.Period period, long durationUs) {
  ...
  private static final class DashTimeline extends Timeline {
    ...
    private long getAdjustedWindowDefaultStartPositionUs(long defaultPositionProjectionUs) {
      ...
      com.rd.exoplayer2.source.dash.manifest.Period period =
