 ...
 */
package com.rd.exoplayer2.metadata;

import com.rd.exoplayer2.Format;
import com.rd.exoplayer2.metadata.emsg.EventMessageDecoder;
import com.rd.exoplayer2.metadata.id3.Id3Decoder;
import com.rd.exoplayer2.metadata.scte35.SpliceInfoDecoder;
      ...
      try {
        switch (mimeType) {
          case MimeTypes.APPLICATION_ID3:
            return Class.forName("com.rd.exoplayer2.metadata.id3.Id3Decoder");
          case MimeTypes.APPLICATION_EMSG:
            return Class.forName("com.rd.exoplayer2.metadata.emsg.EventMessageDecoder");
          case MimeTypes.APPLICATION_SCTE35:
            return Class.forName("com.rd.exoplayer2.metadata.scte35.SpliceInfoDecoder");
          default:
            return null;
        }
