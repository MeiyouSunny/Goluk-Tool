...
import com.rd.exoplayer2.audio.AudioCapabilities;
import com.rd.exoplayer2.audio.AudioProcessor;
import com.rd.exoplayer2.audio.AudioRendererEventListener;
import com.rd.exoplayer2.audio.MediaCodecAudioRenderer;
import com.rd.exoplayer2.decoder.DecoderCounters;
import com.rd.exoplayer2.drm.DrmSessionManager;
import com.rd.exoplayer2.drm.FrameworkMediaCrypto;
import com.rd.exoplayer2.mediacodec.MediaCodecSelector;
import com.rd.exoplayer2.metadata.Metadata;
import com.rd.exoplayer2.metadata.MetadataRenderer;
...
import com.rd.exoplayer2.video.MediaCodecVideoRenderer;
import com.rd.exoplayer2.video.VideoRendererEventListener;
...
//    buildTextRenderers(context, mainHandler, extensionRendererMode, componentListener, out);
    ...
    protected void buildVideoRenderers(Context context, Handler mainHandler,
        ...
        try {
            Class<?> clazz =
                    Class.forName("com.rd.exoplayer2.ext.vp9.LibvpxVideoRenderer");
    ...
    protected void buildAudioRenderers(Context context, Handler mainHandler,
        ...
        try {
            Class<?> clazz =
                    Class.forName("com.rd.exoplayer2.ext.opus.LibopusAudioRenderer");
        ...
        try {
            Class<?> clazz =
                    Class.forName("com.rd.exoplayer2.ext.flac.LibflacAudioRenderer");
            Constructor<?> constructor = clazz.getConstructor(Handler.class,
                    AudioRendererEventListener.class, AudioProcessor[].class);
            Renderer renderer = (Renderer) constructor.newInstance(mainHandler, componentListener,
                    audioProcessors);
        ...
        try {
            Class<?> clazz =
                    Class.forName("com.rd.exoplayer2.ext.ffmpeg.FfmpegAudioRenderer");
            Constructor<?> constructor = clazz.getConstructor(Handler.class,
                    AudioRendererEventListener.class, AudioProcessor[].class);
            Renderer renderer = (Renderer) constructor.newInstance(mainHandler, componentListener,
                    audioProcessors);
