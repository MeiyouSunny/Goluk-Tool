...
public interface ISdkCallBack {
     ...
     *
     * @param context    应用上下文
     * @param exportType 回调类型 来自简单录制 {@link SdkEntry#CAMERA_EXPORT}<br>
     ...
     *
     * @param context    应用上下文
     * @param exportType 回调类型 来自普通截取视频的时间导出{@link SdkEntry#TRIMVIDEO_EXPORT}<br>
     ...
     *
     * @param context    应用上下文
     * @param exportType 来自普通截取的确认 {@link SdkEntry#TRIMVIDEO_EXPORT}<br>
