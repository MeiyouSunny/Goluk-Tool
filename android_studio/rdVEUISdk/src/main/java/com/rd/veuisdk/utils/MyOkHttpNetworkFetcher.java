...
/**
 */
class MyOkHttpNetworkFetcher extends BaseNetworkFetcher<MyOkHttpNetworkFetcher.MyOkHttpNetworkFetchState> {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    try {
                        ...
                        Log.e(TAG, "onResponse: Exception when closing response body" + e);
                    }
                }
            }
        });
