...
import com.rd.veuisdk.utils.SysAlertDialog.CancelListener;
...
public class SysAlertDialog {
     ...
     */
    public static ExtProgressDialog showLoadingDialog(Context context,
                                                      int strId, boolean cancelable, OnCancelListener listener) {
...
class AlertDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m_vContentView = inflater.inflate(R.layout.rdveuisdk_alert_dialog, null);
...
class AlertListViewDialog extends Dialog {
    ...
    public void setcanclelistener(CancelListener _ml) {
        ml = _ml;
