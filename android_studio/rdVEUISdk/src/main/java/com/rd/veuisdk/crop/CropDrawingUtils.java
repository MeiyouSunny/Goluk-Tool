...
public abstract class CropDrawingUtils {
    ...
    public static void drawIndicators(Canvas canvas, Drawable[] cropIndicators,
        ...
        if ((selection == CropObject.TOP_LEFT) || notMoving) {
            drawIndicator(canvas, cropIndicators[0], indicatorSize,
                    bounds.left, bounds.top);
        }
        if ((selection == CropObject.TOP_RIGHT) || notMoving) {
            drawIndicator(canvas, cropIndicators[1], indicatorSize,
                    bounds.right, bounds.top);
        }
        if ((selection == CropObject.BOTTOM_LEFT) || notMoving) {
            drawIndicator(canvas, cropIndicators[2], indicatorSize,
                    bounds.left, bounds.bottom);
        }
        if ((selection == CropObject.BOTTOM_RIGHT) || notMoving) {
            drawIndicator(canvas, cropIndicators[3], indicatorSize,
                    bounds.right, bounds.bottom);
        }
        if (!fixedAspect) {
            if (((selection & CropObject.MOVE_LEFT) != 0) || notMoving) {
                drawIndicator(canvas, cropIndicators[4], indicatorSize,
            ...
            if (((selection & CropObject.MOVE_TOP) != 0) || notMoving) {
                drawIndicator(canvas, cropIndicators[5], indicatorSize,
