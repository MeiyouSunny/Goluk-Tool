...
public class PinnedSectionListView extends ListView {
	...
	if (nextPosition < getCount()) {
		...
		View nextSectionView = getChildAt(nextSectionPosition
			- firstVisibleItem);
		// Log.e("nextSectionView", (nextSectionView == null)
		// + ",,,,,,,,,,,,," + nextSectionPosition + "..........."
		// + firstVisibleItem + ".........");
		if (null != nextSectionView) {
			...
			// next section does not overlap with pinned, stick to
			// top
			mTranslateY = 0;
		    }
...
//	}
	...
	if (mPinnedSection != null) {
	    ...
	    // com.rd.utils.Log.e("pleft...", pLeft + ".........."
	    // + (pTop + mTranslateY) + "..........." + pTop
	    // + "..........." + mTranslateY);
