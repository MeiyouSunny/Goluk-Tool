...
public class AssistUtil {
    ...
    public static final long MAX_SIZE = 500 * 1000 * 1000; // ~5MB set this value too low and there might be a problem handling multiple files
    ...
    public static File getWorkingDir(Context context) {
        ...
        if (cacheDir != null) {
            workingDir = new File(String.format("%s/apng/nomedia/", PathUtils.getRdTempPath()));
