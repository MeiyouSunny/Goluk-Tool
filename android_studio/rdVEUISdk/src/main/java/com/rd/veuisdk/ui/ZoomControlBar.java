...
public class ZoomControlBar extends ZoomControl {
    ...
    private static final int THRESHOLD_FIRST_MOVE = CoreUtils.dpToPixel(10); // pixels
    // Space between indicator icon and the zoom-in/out icon.
    private static final int ICON_SPACING = CoreUtils.dpToPixel(12);
    ...
    private int mPaddingLeft = CoreUtils.dpToPixel(5),
            mPaddingRight = CoreUtils.dpToPixel(10);
