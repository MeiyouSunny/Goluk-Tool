...
public class SdkService {
     ...
     *
     * @param exportConfig 编辑导出配置项
     * @param uiConfig     编辑界面配置项
     * @param cameraConfig 拍摄录制配置项
     */
     ...
     * 初始化视频编辑导出、视频编辑界面配置项
     *
     * @param exportConfig 视频编辑导出配置项
     * @param uiConfig     视频编辑界面配置项
     */
    public void initConfiguration(ExportConfiguration exportConfig,
     ...
     * 持久化保存对象
     *
     * @param sp     保存对象关联的SharedPreferences
