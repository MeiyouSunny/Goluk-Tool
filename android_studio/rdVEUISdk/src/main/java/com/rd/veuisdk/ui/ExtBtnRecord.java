...
public class ExtBtnRecord extends RotateImageView {
    ...
    public ExtBtnRecord(Context context, AttributeSet attrs) {
        ...
        hasL = CoreUtils.hasL();
//        m20dp = getResources().getDimensionPixelSize(R.dimen.btn_recorder_padding);
        m20dp = CoreUtils.dpToPixel(20);
    }
...
//            lp.setMargins(mleft, mtop, 0, 0);  切记不能setmargin()
    ...
    private int FTARGETSCALE = CoreUtils.dpToPixel(62);
    ...
    public static interface onLongListener {
