...
import cn.com.mobnote.golukmobile.player.ApiHelper;
...
public class TextureVideoView extends TextureView
    ...
    private GolukPlayer mMediaPlayer = null;
    private int         mAudioSession;
    private int         mVideoWidth;
    private int         mVideoHeight;
//    private MediaController mMediaController;
    private GolukPlayer.OnCompletionListener mOnCompletionListener;
    private GolukPlayer.OnPreparedListener mOnPreparedListener;
    private int         mCurrentBufferPercentage;
    private GolukPlayer.OnErrorListener mOnErrorListener;
    private GolukPlayer.OnInfoListener  mOnInfoListener;
    ...
    private void openVideo() {
        ...
        try {
        	...
        	if (ApiHelper.AT_LEAST_16) {
        		mMediaPlayer = PlayerFactory.createPlayer(PlayerFactory.EXO_PLAYER);
        	} else {
        		mMediaPlayer = PlayerFactory.createPlayer(PlayerFactory.DEFAULT_PLAYER);
        	}
            if (mAudioSession != 0) {
...
//    }
    ...
    GolukPlayer.OnVideoSizeChangedListener mSizeChangedListener = new GolukPlayer.OnVideoSizeChangedListener() {
	...
	GolukPlayer.OnPreparedListener mPreparedListener = new GolukPlayer.OnPreparedListener() {
...
//			}
			...
			if (mVideoWidth != 0 && mVideoHeight != 0) {
				...
				// mVideoHeight);
				getSurfaceTexture().setDefaultBufferSize(mVideoWidth, mVideoHeight);
				// We won't get a "surface changed" callback if the surface is
				// already the right size, so
...
//					}
    ...
    private GolukPlayer.OnCompletionListener mCompletionListener =
            new GolukPlayer.OnCompletionListener() {
...
//                    }
    ...
    private GolukPlayer.OnInfoListener mInfoListener =
            new GolukPlayer.OnInfoListener() {
				@Override
	...
	private GolukPlayer.OnErrorListener mErrorListener = new GolukPlayer.OnErrorListener() {
		@Override
...
//			}
    ...
    private GolukPlayer.OnBufferingUpdateListener mBufferingUpdateListener =
            new GolukPlayer.OnBufferingUpdateListener() {

				@Override
				public void onBufferingUpdate(GolukPlayer mp, int percent) {
					// TODO Auto-generated method stub
     ...
     */
    public void setOnPreparedListener(GolukPlayer.OnPreparedListener l)
    {
     ...
     * @param l The callback that will be run
     */
    public void setOnCompletionListener(GolukPlayer.OnCompletionListener l)
    {
     ...
     * @param l The callback that will be run
     */
    public void setOnErrorListener(GolukPlayer.OnErrorListener l)
    {
        mOnErrorListener = l;
    }
     ...
     * @param l The callback that will be run
     */
    public void setOnInfoListener(GolukPlayer.OnInfoListener l) {
        mOnInfoListener = l;
    }
