...
public class IndexMoreNoLoginActivity extends Activity implements OnClickListener {
	/** application */
...
//	private ImageButton mBackBtn = null;
	private RelativeLayout mLayoutBtn = null;
...
/*	*//**个人中心的头像、性别、昵称*//*
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.index_more_nologin);
...
//		mBackBtn = (ImageButton)findViewById(R.id.back_btn);
		mLayoutBtn = (RelativeLayout) findViewById(R.id.back_btn_layout);
...
//		mVideoSquareItem = (RelativeLayout) findViewById(R.id.video_square_item);
		...
		//进入我的主页
		mLayoutNoLogin = (RelativeLayout) findViewById(R.id.head_layout_nologin);		
		/*//头像、性别、昵称
...
//		mVideoSquareItem.setOnClickListener(this);
		...
		mLayoutNoLogin.setOnClickListener(this);
	...
	public void onClick(View v) {
		...
		switch(id){
			...
			case R.id.local_video_item:
				intent = new Intent(IndexMoreNoLoginActivity.this,LocalVideoListActivity.class);
			...
			case R.id.setup_item:
				...
				intent = new Intent(IndexMoreNoLoginActivity.this,UserSetupActivity.class);
				startActivity(intent);
			break;
			//点击跳转到我的主页
			case R.id.head_layout_nologin:
