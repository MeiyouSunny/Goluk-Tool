...
import cn.com.mobnote.golukmobile.userinfohome.bean.UserLabelBean;
...
public class FragmentMine extends Fragment implements OnClickListener,
	...
	public void onClick(View v) {
		...
		case R.id.skill_item:
			Intent itSkill = new Intent(getActivity(),
		...
		case R.id.install_item:
			Intent itInstall = new Intent(getActivity(),
					UserOpenUrlActivity.class);
