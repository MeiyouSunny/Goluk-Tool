...
public class ConfigConstants {
  ...
  private static final String IMAGE_PIPELINE_SMALL_CACHE_DIR = "goluk/image_cache";//小图所放路径的文件夹名
  private static final String IMAGE_PIPELINE_CACHE_DIR = "goluk/image_cache";//默认图所放路径的文件夹名
...
//			  .setOverlays(overlays)
			  .setPlaceholderImage(context.getResources().getDrawable(R.drawable.ic_launcher))
