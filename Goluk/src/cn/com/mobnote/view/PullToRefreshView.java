...
public class PullToRefreshView extends LinearLayout {
	...
	/** 拖动状态 向下拉或向上拉 PULL_UP_STATE or PULL_DOWN_STATE */
	...
	private void init() {
		...
		mFlipAnimation = new RotateAnimation(0,-180,pivoyType,0.5f,pivoyType,0.5f);
		mFlipAnimation.setInterpolator(new LinearInterpolator());
		mFlipAnimation.setDuration(250);
		mFlipAnimation.setFillAfter(true);
		mReverseFlipAnimation = new RotateAnimation(-180, 0, pivoyType, 0.5f, pivoyType, 0.5f);
	...
	private void addHeaderView() {
		...
		// mHeaderUpdateTextView = (TextView)
	...
	protected void onFinishInflate() {
		...
		// 底部 view 在此添加保证添加到linearlayout中的最后
		addFooterView();
