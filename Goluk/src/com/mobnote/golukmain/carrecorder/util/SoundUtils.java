...
public class SoundUtils {
	...
	public SoundUtils() {
		...
		// soundData.put(RECORD_CAMERA, mSoundPool.load(mContext,
		// R.raw.recode_camera, 1));
		// soundData.put(RECORD_EMERGENT, mSoundPool.load(mContext,
		// R.raw.recorde_emergent, 1));
		// soundData.put(RECORD_SEC, mSoundPool.load(mContext,
		// R.raw.recorde_sec, 1));
